    ...
    <header >
      ...
      <nav>
        <div id="barra-superior">
          ...
          <div id="caixa-menu">
            <center>
              <img id="botao-home" src='img/home_menu.png' class="icones-caixaMenu" onmouseover="this.src='img/home_menu-clicked.png'" onmouseout="this.src='img/home_menu.png'" data-toggle="popover" data-placement="bottom"  data-html="true"  />
