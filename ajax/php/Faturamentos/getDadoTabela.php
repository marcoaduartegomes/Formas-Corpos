...
$estatus = $_POST["estatus"];
  if($datas == ""){echo json_encode('');} else{
      $query = "SELECT servico.nome, preco, sum(preco) as montante from consulta inner join servico on codServico = servico.codigo where LOCATE('$datas',start) and estatus = '$estatus' group by servico.nome";  
