...
require_once __DIR__.'/connect.php';
 //getDadoTabela.php retorna do banco de dados todos os valores de um certo codigo para preencher a tabela via ajax 
      $data = "allDay:false";
      $query = "select cliente.nome as title, start,end,allDay,className,description,consulta.codigo from consulta inner JOIN cliente on codCliente = cliente.codigo";  
