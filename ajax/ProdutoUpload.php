...
<form action="" method="POST" enctype="multipart/form-data" class="was-validated" id="form1" autocomplete="off">
 ...
 <label for="quantidade" >Quantidade</label>
    ...
    <br><br><br>
    <div class="col-sm-10">
      <button type="submit" value="Salvar" onclick="alterar()" class="btn btn-primary">Salvar</button>
    </div>
    </div>
...
function zerar()
{
	...
	function comFoto()
{
     ProdutoUpload.getElementById("validatedCustomFile").required=true;
